...
- [x] **`Dry airfried chicken zero added fat 150g`** → fat **≤ 6 g**, protein **43–49 g**, and no
...
- [x] **`Dry airfried chicken breast 250g`** then **`Dry airfried chicken breast 150g`** → every
      macro of the 150 g one is ~60% of the 250 g one (±10%). Fat must not go *up*.
- [x] Any estimate → kcal within ±5% of P×4 + C×4 + F×9 (skip this for anything with alcohol).
- [x] **`3 Warburtons crumpets, 30g butter total (10g each), 10.5g jam total (3.5g each) — P: 9.2g C: 66.5g F: 25.8g 539 kcal`**
      ...
      *(the four above: founder reports "tested ok on both" — chicken and crumpets — 2026-09-15)*
...
### AI capture (v6.7) — ✅ all verified on device 2026-08-16
- [x] Voice/photo capture → the optional follow-up questions flow
- [x] **⚐ Report wrong** opens a prefilled email
- [x] **+ Log all** puts everything into today's food
