...
| **3** | **Smooth earn-to-eat.** Spread a logged workout's kcals across following days (tolerant of rest-day clusters and back-to-back training). | coach (maths) + design | No same-day "unlock"; rest-day behaviour sane; tests. |
